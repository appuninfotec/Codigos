                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <?php } else { ?>
                                <a href="produtos.php?ativar=<?php echo $dadcate->id; ?>"><button class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Ativar Produto"><i class="fa fa-eye"></i></button></a>
                                <?php } ?>
                            </td>
                            <td align="center">
